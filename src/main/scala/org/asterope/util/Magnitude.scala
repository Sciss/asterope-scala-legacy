...
case class Magnitude(mag: Double) extends scala.math.Ordered[Magnitude] {
...
object Magnitude {
  ...
  /** Converts pogson magnitude to normal magnitude */
  def pogson2mag(pogson: Double) = -2.5 * math.log10(pogson)

  /** Converts normal magnitude to pogson magnitude */
