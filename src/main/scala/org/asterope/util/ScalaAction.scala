...
case class ScalaAction(peer: Action) {
  ...
  def largeIcon_=(i: Icon): Unit = peer.putValue(javax.swing.Action.LARGE_ICON_KEY, i)
  def smallIcon    : Icon = ifNull(peer.getValue(javax.swing.Action.SMALL_ICON), ScalaAction.emptyIcon)
  def smallIcon_=(i: Icon): Unit = peer.putValue(javax.swing.Action.SMALL_ICON, i)
  ...
  */
   ...
   */ 
   ...
   def selected_=(b: Option[Boolean]): Unit =
