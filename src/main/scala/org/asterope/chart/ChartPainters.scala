...
class ChartMilkyWay(dao: MilkyWayDao)
  ...
  def updateChart(chart: Chart, config: ChartMilkyWayConfig): Unit = {
...
class ChartConstelLine(dao: ConstelLineDao)
  ...
  def updateChart(chart: Chart, config: ChartConstelLineConfig): Unit = {
...
class ChartConstelBoundary(dao: ConstelBoundaryDao)
  ...
  def updateChart(chart: Chart, config: ChartConstelBoundaryConfig): Unit =
    for {
