...
/** The class defines coordinate systems in terms of the
  ...
  * may involve more complex transformations.
  *
...
abstract class CoordinateSystem {
  ...
  /** Gets the rotation associated with the projection. */
  def getRotater: Rotater

  /** Gets the distortion associated with the projection.
    * By default there is no distortion, but subclasses,
    * notably BesselianProjection, can override this.
    */
  def getSphereDistorter: SphereDistorter = null
...
object CoordinateSystem {
   ...
   */
  def factory(name: String): CoordinateSystem = factory(name, null)
  ...
  def factory(name2: String, equinox: String): CoordinateSystem = {
    ...
    c match {
      ...
      case 'B' =>
        ...
        new CoordinateSystemBesselian(epoch)
      case 'E' =>
        new Ecliptic(epoch, 0)
      case 'H' =>
        new Helioecliptic(epoch)
      case _ =>
        null
    }
  }
  ...
  object Galactic extends CoordinateSystem {
    ...
    def getDescription  = "Coordinate system based upon the orientation and center of the Galaxy"

    private val poles   = Array[Double](122.931918, 27.128251, 192.859481)
    val getRotater      = Rotater("ZYZ", math.toRadians(poles(2)),
  ...
  class Julian(epoch: Double) extends CoordinateSystem {
    ...
    private def precession: Rotater = {
      ...
      val theta = (2004.3109 + (-0.42665 - 0.041833 * t) * t) * tas2r
  ...
  class Ecliptic(epoch: Double, elon: Double = 0) extends CoordinateSystem {
    def getName         = "E" + epoch
    def getDescription  = "A coordinate system with the ecliptic as the equator at epoch of equinox" + epoch
    ...
    val getRotater: Rotater = {
      ...
      val r2 = Rotater("XZ", eps0, elon, 0.0)
      if (r1 == null) r2
      else r1.add(r2)
    }
  }
  ...
  protected object Helioecliptic {
    ...
    def sunlong(epoch: Double): Double = {
      ...
      val t: Double = ((epoch - 2000) * 365.25 + 2451544.5 - 2415020) / 36525.0
