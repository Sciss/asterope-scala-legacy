...
object Angle{	
  ...
  /**
    ...
    def parseRa(ra: String): Angle = {
      ...
      ra match {
        ...
        case r3(d,m,s) => (d.toDouble: AngleWrapperDouble).degree +
                          (m.toDouble: AngleWrapperDouble).arcMinute +
                          (m.toDouble: AngleWrapperDouble).arcSec
  ...
  def parseRaDe(str:String):(Angle,Angle) = {
    ...
    str match {
      ...
      case r4(ra,de) => ((ra.toDouble: AngleWrapperDouble).arcHour, (de.toDouble: AngleWrapperDouble).degree)
      case r5(ra,de) => ((ra.toDouble: AngleWrapperDouble).degree, (de.toDouble: AngleWrapperDouble).degree)
