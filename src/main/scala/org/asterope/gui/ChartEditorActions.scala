...
trait ChartEditorActions {
  ...
  private def setFov(fov: Angle): Unit = {
   ...
   * move actions
   */
  private def chartMove(x: Double, y: Double): Unit = {
  ...
  val actCoordGridEclipticShowLines = mainWinActions.actCoordGridEclipticShowLines.editorAction(this) {
    coordGridConfig = coordGridConfig.copy(coordinateGridEcliptic =
      coordGridConfig.coordinateGridEcliptic.copy(showLines = !coordGridConfig.coordinateGridEcliptic.showLines))
    refresh()
  }
  val actCoordGridGalacticShowLines = mainWinActions.actCoordGridGalacticShowLines.editorAction(this) {
    coordGridConfig = coordGridConfig.copy(coordinateGridGalactic =
      coordGridConfig.coordinateGridGalactic.copy(showLines = !coordGridConfig.coordinateGridGalactic.showLines))
    refresh()
  }

  val actCoordGridJ2000ShowPoles = mainWinActions.actCoordGridJ2000ShowPoles.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridJ2000 =
      coordGridConfig.coordinateGridJ2000.copy(showPoles = !coordGridConfig.coordinateGridJ2000.showPoles))
    refresh()
  }
  val actCoordGridB1950ShowPoles = mainWinActions.actCoordGridB1950ShowPoles.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridJ1950 =
      coordGridConfig.coordinateGridJ1950.copy(showPoles = !coordGridConfig.coordinateGridJ1950.showPoles))
    refresh()
  }
  val actCoordGridEclipticShowPoles = mainWinActions.actCoordGridEclipticShowPoles.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridEcliptic =
      coordGridConfig.coordinateGridEcliptic.copy(showPoles = !coordGridConfig.coordinateGridEcliptic.showPoles))
    refresh()
  }
  val actCoordGridGalacticShowPoles = mainWinActions.actCoordGridGalacticShowPoles.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridGalactic =
      coordGridConfig.coordinateGridGalactic.copy(showPoles = !coordGridConfig.coordinateGridGalactic.showPoles))
    refresh()
  }

  val actCoordGridJ2000ShowEquator = mainWinActions.actCoordGridJ2000ShowEquator.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridJ2000 =
      coordGridConfig.coordinateGridJ2000.copy(showEquator = !coordGridConfig.coordinateGridJ2000.showEquator))
    refresh()
  }
  val actCoordGridB1950ShowEquator = mainWinActions.actCoordGridB1950ShowEquator.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridJ1950 =
      coordGridConfig.coordinateGridJ1950.copy(showEquator = !coordGridConfig.coordinateGridJ1950.showEquator))
    refresh()
  }
  val actCoordGridEclipticShowEquator = mainWinActions.actCoordGridEclipticShowEquator.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridEcliptic =
      coordGridConfig.coordinateGridEcliptic.copy(showEquator = !coordGridConfig.coordinateGridEcliptic.showEquator))
    refresh()
  }
  val actCoordGridGalacticShowEquator = mainWinActions.actCoordGridGalacticShowEquator.editorAction(this){
    coordGridConfig = coordGridConfig.copy(coordinateGridGalactic =
      coordGridConfig.coordinateGridGalactic.copy(showEquator = !coordGridConfig.coordinateGridGalactic.showEquator))
    refresh()
  }
